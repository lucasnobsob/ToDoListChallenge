    ...
    public class ViewModelToDomainMappingProfile : Profile
    {
        public ViewModelToDomainMappingProfile()
        {
            CreateMap<CreateTaskItemViewModel, RegisterNewTaskCommand>()
                .ConstructUsing(src => new RegisterNewTaskCommand(src.Title, src.Description, src.DueDate, (TaskItemStatus)src.Status));

            CreateMap<UpdateTaskItemViewModel, UpdateTaskCommand>()
                .ConstructUsing(src => new UpdateTaskCommand(src.Id, (TaskItemStatus)src.Status));
        }
    }
}
