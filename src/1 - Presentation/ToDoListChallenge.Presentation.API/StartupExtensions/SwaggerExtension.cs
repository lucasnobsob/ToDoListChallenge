    ...
    public static class SwaggerExtension
    {
        public static IServiceCollection AddCustomizedSwagger(this IServiceCollection services, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                services.AddSwaggerGen(c =>
                {
                    ...
                    {
                        Version = "v1",
                        Title = "ToDoListChallenge Code Challenge",
                        Description = "",
                        ...
                        License = new OpenApiLicense() { Name = "GNU", Url = new Uri("https://github.com/lucasnobsob/ToDoListChallenge-CodeChallenge/blob/main/LICENSE") }
                    });
        ...
        public static IApplicationBuilder UseCustomizedSwagger(this IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ToDoListChallenge Code Challenge API");
                });
            }
